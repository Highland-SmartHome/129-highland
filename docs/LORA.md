...
Node-RED polls the household email account (configured in `secrets.json`) on a regular interval via IMAP, parses for Informed Delivery emails, and classifies them by type.
...
*Last Updated: 2026-03-13 — Redacted email addresses for public repo. Previous: 2026-03-10 — Corrected Scheduler Integration section.*
