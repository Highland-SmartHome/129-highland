...
| Document | Purpose |
|----------|----------|
| [APPLIANCE_MONITORING.md](docs/APPLIANCE_MONITORING.md) | Power-based cycle detection for washer/dryer/dishwasher |
...
| [PERSISTENT_MEMORY.md](docs/PERSISTENT_MEMORY.md) | AI assistant memory architecture |
